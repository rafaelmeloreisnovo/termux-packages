...
/*
 * Phase-1 sidecar. Manifest V2 remains exactly 200 bytes.
 * The 33-bit diagnostic signature is therefore NOT serialized into _reserved.
 */
typedef struct {
...
/*
 * 33-bit diagnostic fingerprint compatible with the Phase-1 sketch.
 * It is an integrity heuristic, not a proof of a code with d_min >= 3,
 * and no single-error-correction claim is made.
 */
